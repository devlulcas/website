<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 512 512" {...$$props}
	><!-- Icon from Circle Flags by HatScripts - https://github.com/HatScripts/circle-flags/blob/gh-pages/LICENSE --><mask
		id="SVGuywqVbel"><circle cx="256" cy="256" r="256" fill="#fff" /></mask
	><g mask="url(#SVGuywqVbel)"
		...
		/><path fill="#ffda44" d="m234 186l-12 11v11l18-9c3-1 3-5 1-7z" /><circle
			cx="172"
			cy="275"
			r="8"
			fill="#ffda44"
